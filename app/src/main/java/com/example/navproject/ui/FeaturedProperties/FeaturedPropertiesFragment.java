...
public class FeaturedPropertiesFragment extends Fragment {
    ...
    private FeaturedPropertiesViewModel mViewModel;

    public static FeaturedPropertiesFragment newInstance() {
        return new FeaturedPropertiesFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(FeaturedPropertiesViewModel.class);
